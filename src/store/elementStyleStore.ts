...
const useElementStyleStore = defineStore("elementStyleStore", {
    state: () => {
        return {
            ...
            .set('button','background-color: #4e4e4e;width: 70px;height: 25px;color: white;border-radius: 5px;font-size: 16px;cursor: pointer;')
            .set('input','background-color: #fff;width: 100px;height: 30px;padding: 5px;border: 1px soild #ccc;border-radius: 5px;font-size: 16px;')
            .set('img','background-color: #4e4e4e;width: 100px;height: 100px;')
            .set('div','background-color: #4e4e4e;width:50px;height: 50px;border: none;border-radius: 5px;font-size: 16px;')
        }
    },
    actions: {
